...
export = async () => {
	...
	return all([
		...
		const exported = {
			spork_codestar_ecr: ecr,
			spork_codestar_codedeploy: codedeploy,
			spork_codestar_appconfig: appconfig,
			spork_codestar_codeartifact: codeartifact,
			spork_codestar_ssm: ssm,
