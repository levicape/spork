...
export const SporkDnsRootStackrefRoot = "dns-root" as const;

export const SporkDnsRootStackExportsZod = z
	.object({
		spork_dns_root_route53: z.object({
			zone: z
				.object({
