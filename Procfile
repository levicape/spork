bootstrap: mkdir -p /tmp || true; cp ./iac/bootstrap/$BOOTSTRAP_ARCH/bootstrap /tmp/bootstrap || true; chmod +x /tmp/bootstrap || true; ls -la /tmp || true; echo 'bootstrap $BOOTSTRAP_ARCH complete'; sleep 1200s;
